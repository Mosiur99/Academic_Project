...
//	glColor3f(0.0,1.0,0.0);  // disp box
...
void display()
{
	...
	else if (abtflag == true)
	{
		...
		drawString(23,53,0,GLUT_BITMAP_HELVETICA_18,"            MD. Mosiur Zzaman & Md. Kamrul Hassan Khan");
...
int main(int argc, char** argv)
{
	...
	init();
	glutDisplayFunc(display);///536
	glutReshapeFunc(myReshape);///875
	glutMouseFunc(mouse);///774
	glutKeyboardFunc(keyPressed);///860
	glutMainLoop();
	return 0;
}
